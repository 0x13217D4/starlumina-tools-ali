Page({
  ...
  calculateResult: function() {
    ...
    this.setData({
      result: {
        type: mbtiType,
        name: (typeDescriptions[mbtiType] && typeDescriptions[mbtiType].name) || "未知类型",
        description: (typeDescriptions[mbtiType] && typeDescriptions[mbtiType].description) || "你的MBTI类型是" + mbtiType
      }
    });
  },
